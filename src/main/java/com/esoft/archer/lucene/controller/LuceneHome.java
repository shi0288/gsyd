...
public class LuceneHome {
	...
	public PageModel<ResultBean> getResults(String value, Integer pageNo) {
		...
		this.pageModel = luceneService.paginationResult(value,
				FacesUtil.getAppRealPath() + LuceneConstants.LUCENE_INDEX_PATH, pageNo, getPageSize());
		return pageModel;
	}
	...
	public String rebuildIndex() {
		try {
			...
			luceneService.rebuildIndex(FacesUtil.getAppRealPath() + LuceneConstants.LUCENE_INDEX_PATH);
