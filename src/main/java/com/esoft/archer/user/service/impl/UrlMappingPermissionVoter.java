...
public class UrlMappingPermissionVoter implements AccessDecisionVoter {
	...
	public PrettyConfig getConfig(HttpServletRequest hreq) {
		...
		PrettyConfig pc = (PrettyConfig) hreq.getSession(true)
				.getServletContext().getAttribute(MyPrettyFilter.CONFIG_KEY);
		...
		if (pc == null) {
			...
			hreq.getSession(true).getServletContext()
					.setAttribute(MyPrettyFilter.CONFIG_KEY, pc);
	...
	public int vote(Authentication authentication, Object object,
		...
		if (mapping != null) {
			...
			if (um != null) {
				...
				Collection<? extends GrantedAuthority> grantedAs = authentication
						.getAuthorities();
