...
public class FacesUtil {
	...
	public static boolean isIEBrowser() {
		return getHttpServletRequest().getHeader("USER-AGENT").toLowerCase()
				.contains("msie");
	}
	...
	public static boolean isMobileRequest(HttpServletRequest request) {
		...
		ConfigService cs = (ConfigService) SpringBeanUtil
				.getBeanByName("configService");
		return userAgent.contains("Mobile") && !userAgent.contains("iPad")
				&& "1".equals(cs.getConfigValue("enable_mobile_site"));
	}
