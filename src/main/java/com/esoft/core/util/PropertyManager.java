...
public class PropertyManager {
    ...
    private static String propsName = "/resources.properties";
   ...
   public static void savePropsToFile(Properties properties) {
    ...
    private void saveProps() {
        ...
        String path=PropertyManager.class.getResource(this.propsName).getPath();
        OutputStream out = null;
        try {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getProperty("uuuu"));
        setProperty("uuuu","22222222");
        System.out.println(getProperty("upload_base"));
